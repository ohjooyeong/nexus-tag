        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8">
          ...
          >
            <div className="aspect-video flex items-center justify-center">
              ...
              <Avatar className="-ml-6 border-transparent bg-transparent">
                <div className="flex size-full bg-neutral-500 rounded-full items-center justify-center gap-1">
          ...
          {features.map((feature) => (
            <div
              ...
              className="bg-neutral-100 border-white/10 inline-flex px-3 md:px-5 py-1.5 md:py-2
                rounded-2xl gap-3 items-center"
            >
              <span
